...
# @pytest.mark.parametrize(
#     "day_str, timezone, zone_ceuta_melilla, num_prices, num_calls",
#     (
#         ("2021-06-01 06:00:00", REFERENCE_TZ, False, 24, 1),
#     ),
# )
# @pytest.mark.asyncio
# async def test_new_220td_tariff(
#     day_str, timezone, zone_ceuta_melilla, num_prices, num_calls
# ):
#     """Test data parsing of official API files."""
#     from aiopvpc.pvpc_download import extract_pvpc_data
#
#     prices = extract_pvpc_data()
#     day = datetime.fromisoformat(day_str)
#     mock_session = MockAsyncSession()
#
#     pvpc_data = PVPCData(
